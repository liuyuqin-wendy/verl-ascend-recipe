...
from verl.workers.rollout.fault_tolerance.weight_sync import StaleWeightSyncAttempt
...
class BucketedWeightSender:
    ...
    def _send_bucket(self, bucket_meta: dict[str, TensorMetadata], *, is_last: bool) -> None:
